...
var Header = /** @class */ (function (_super) {
    ...
    Header.prototype.setFixedHeader = function (userConfig) {
        for (var _i = 0, _a = this.columns; _i < _a.length; _i++) {
            var column = _a[_i];
    ...
    StorageResponseToArrayTransformer.prototype.castData = function (data) {
        ...
        if (typeof data[0] === 'object' && !(data[0] instanceof Array)) {
            return data.map(function (row) {
                return _this.props.header.columns.map(function (column) {
...
var PluginRenderer = /** @class */ (function (_super) {
    ...
    PluginRenderer.prototype.render = function () {
        return v(p, {}, this.config.plugin.list(this.props.position).map(function (p) { return p.component; }));
    };
...
var Config = /** @class */ (function () {
    ...
    Config.fromUserConfig = function (userConfig) {
        ...
        config.plugin.add({
            ...
            component: v(Search, __assign({ enabled: userConfig.search === true || userConfig.search instanceof Object }, userConfig.search)),
        });
        // Pagination
        config.plugin.add({
            id: 'pagination',
            position: PluginPosition.Footer,
            component: v(Pagination, __assign({ enabled: userConfig.pagination === true ||
...
var TD = /** @class */ (function (_super) {
    ...
    TD.prototype.render = function () {
        return (v("td", __assign({ role: this.props.role, colSpan: this.props.colSpan, "data-column-id": this.props.column && this.props.column.id, className: classJoin(className('td'), this.props.className, this.config.className.td), style: __assign({}, this.config.style.td), onClick: this.handleClick.bind(this) }, this.getCustomAttributes(this.props.column)), this.content()));
    };
    return TD;
}(BaseComponent));
...
var TH = /** @class */ (function (_super) {
    ...
    TH.prototype.render = function () {
        ...
        return (v("th", __assign({ "data-column-id": this.props.column && this.props.column.id, className: classJoin(className('th'), this.isSortable() ? className('th', 'sort') : null, this.props.column.fixedHeader ? className('th', 'fixed') : null, this.config.className.th), onClick: this.onClick.bind(this), style: __assign(__assign({}, this.config.style.th), { width: this.props.column.width }), onKeyDown: this.keyDown.bind(this) }, props),
        ...
        return (v(configContext.Provider, { value: this.props.config },
            v("div", { role: "complementary", className: classJoin('gridjs', className('container'), this.state.status === Status.Loading ? className('loading') : null, this.props.config.className.container), style: __assign(__assign({}, this.props.config.style.container), {
                ...
                v("div", { className: className('wrapper'), style: { width: this.props.width, height: this.props.height } },
                    v(Table, { data: this.state.data, header: this.state.header, width: this.props.width, height: this.props.height, status: this.state.status })),
...
export { BaseComponent, d as Component, Config, Grid, PluginPosition, v as createElement, y as createRef, v as h, html, y$1 as useEffect, h$1 as useRef };
