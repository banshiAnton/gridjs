import { BaseStore, BaseActions, h, className, PluginBaseComponent } from 'gridjs';
...
var RowSelection = /** @class */ (function (_super) {
    ...
    RowSelection.prototype.render = function () {
        ...
        if (this.isDataCell(this.props)) {
            return (h("input", { type: 'checkbox', checked: this.state.isChecked, onChange: function () { return _this.toggle(); }, className: this.props.checkboxClassName }));
        }
        return null;
    };
...
export { RowSelection, RowSelectionActions, RowSelectionStore };
//# sourceMappingURL=gridjs-selection.development.es.js.map
